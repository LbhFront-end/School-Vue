      ...
      <div class="list flex-row flex-left flex-space-between">
        <div class="list-left">
            <ul class="list-left-inner flex-col flex-space-between flex-x-center">
              <router-link :to="{path:'/GermanManagement'}"><li class="green-bg">建党天地</li></router-link>
            </ul>
        </div>
        <div class="list-right flex-col">
          <div class="list-right-title flex-row flex-y-center"><span class="list-right-title-inner">您当前的位置：建党天地</span></div>
